...
def calculate_cost(model, X, y, batch_size, reg):
    ...
    for index in range(n_batches):
        ...
        print(clean_loss.item(), jacobian_loss.item())
...
def Training(Dataset, batch_size, n_epoch, lr):
    ...
    for epoch in range(n_epoch):
        ...
        for index in samples:
            ...
            grad_loss_sum += jacobian_loss.item()
            loss.backward()
        ...
        validate_cost = calculate_cost(model, X_Validation, y_Validation, batch_size, reg)
