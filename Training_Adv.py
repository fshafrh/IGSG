...
def calculate_cost(model, X, y, batch_size, adversary):
...
def Training(Dataset, batch_size, n_epoch, lr):
    ...
    scheduler = ReduceLROnPlateau(optimizer, 'min', factor=0.8, patience=50, cooldown=50, eps=1e-6)
    ...
    for epoch in range(n_epoch):
        ...
        validate_cost = calculate_cost(model, X_Validation, y_Validation, batch_size, adversary)
